...
Public Class SampleDisplayForm
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        e.Graphics.FillRectangle(brushRed, rect.X, rect.Y, Convert.ToInt32(rect.Width * _percentage), rect.Height)
        e.Graphics.FillRectangle(brushYellow, rect.X + Convert.ToInt32(rect.Width * _percentage), rect.Y, rect.Width - Convert.ToInt32(rect.Width * _percentage), rect.Height)
    End Sub
End Class